        ...
        <div className="max-w-3xl mx-auto space-y-8">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-brand-gray mt-1">Add a new apparel item to your catalog</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-brand-light space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            placeholder="Describe the product, its craftsmanship, and unique details..."
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-brand-light space-y-6">
                    ...
                    <p className="text-sm text-brand-gray -mt-4">Share the story of the artisan who crafted this piece</p>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            rows={3}
                            className="w-full p-4 bg-brand-light/30 border border-brand-light rounded-2xl focus:ring-2 focus:ring-brand-accent/20 focus:border-brand-accent outline-none transition-all font-medium resize-none"
                            placeholder="This piece was crafted by [Name], who joined KVTC [time] ago. Through dedicated training..."
